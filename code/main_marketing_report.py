...
#
# A missing argument, or a blank one from the VS Code seed prompt, means "use the
# sample data". sys.argv[1] arrives as a string, so it needs int().
...
# 3. Load — the item table, a blank line, then the two headline lines.
